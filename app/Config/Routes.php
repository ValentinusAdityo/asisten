...
// latihan menampilkan tabel database
...
$routes->match(['get', 'post'], 'asisten/check', 
[AsistenController::class, 'check']);
$routes->get('asisten/logout', [AsistenController::class, 'logout']);
$routes->get('/asisten/tampil', 'AsistenController::tampil');

// latihan session dan cookies framework
